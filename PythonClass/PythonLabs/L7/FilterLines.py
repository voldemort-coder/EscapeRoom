    ...
    while True:
        try:
            ...
            with open(output_file, 'w', encoding='utf-8') as outfile:
                for line in lines:
                    # Verificăm dacă linia conține cuvântul cheie
                    if keyword in line:
                        outfile.write(line)

            print(f"Fișierul '{output_file}' a fost creat cu succes, conținând doar liniile cu '{keyword}'!")
...
while True:
    try:
        ...
        keyword = input("Introdu cuvântul cheie pentru filtrare: ")
